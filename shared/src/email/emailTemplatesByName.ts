    ...
    CANCELLED_CONVENTION_NOTIFICATION: {
      ...
      Nous vous informons que la demande ${
        internshipKind === "immersion"
          ? "d'immersion professionnelle"
          : "de mini stage"
      } de ${beneficiaryFirstName} ${beneficiaryLastName} dans l'entreprise ${businessName}, qui devait se dérouler du ${formatDate(dateStart)} au ${formatDate(dateEnd)} a été annulée par ${agencyName}.
    ...
    DEPRECATED_CONVENTION_NOTIFICATION: {
      ...
      Nous vous informons que la demande ${
        ...
        internshipKind === "immersion"
          ...
          : "un mini stage"
      } du ${formatDate(dateStart)} au ${formatDate(dateEnd)} dans l'entreprise ${businessName} est supprimée.
