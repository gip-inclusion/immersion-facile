...
Profil du candidat :
    ...
    ${
      params.discussionKind === "IF" && params.potentialBeneficiaryHasWorkingExperience
    ...
    ${
      params.discussionKind === "IF" && params.potentialBeneficiaryExperienceAdditionalInformation
        ? `• Informations supplémentaires sur l'expérience du candidat : ${params.potentialBeneficiaryExperienceAdditionalInformation}.`
        : ""
    }
    ${ 
      params.discussionKind === "1_ELEVE_1_STAGE" && params.levelOfEducation
