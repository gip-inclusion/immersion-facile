...
export const assessmentStatuses = ["COMPLETED", "PARTIALLY_COMPLETED", "DID_NOT_SHOW"] as const;
export const typeOfContracts = ["CDI", "CDD > ou = 6 mois", "CDD < 6 mois", "Alternance", "Contrat aidé", "Contrat d'insertion", "Autre"] as const;
export type TypeOfContract = (typeof typeOfContracts)[number];


// step 1
export type WithAssessmentStatus = { status: ExtractFromExisting<AssessmentStatus, "COMPLETED" | "DID_NOT_SHOW"> } | {
...
// step 2
export type WithEndedWithAJob = { endedWithAJob: false } | {
  endedWithAJob: true,
...
} & WithAssessmentStatus & WithEndedWithAJob & WithEstablishmentComments
