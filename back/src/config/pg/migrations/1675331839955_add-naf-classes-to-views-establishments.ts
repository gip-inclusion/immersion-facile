...
export async function up(pgm: MigrationBuilder): Promise<void> {
  ...
  pgm.createMaterializedView(
    viewEstablishments,
    {},
    establishmentsMaterializedView("up"),
  );
  pgm.createMaterializedView(
    viewEstablishmentsWithAggregatedOffers,
    {},
    viewEstablishmentsWithAggregatedOffersSql("up"),
  );
  pgm.createMaterializedView(
    viewEstablishmentWithFlattenOffers,
    {},
    viewEstablishmentsWithFlattenOffersSql("up"),
  );
}
...
export async function down(pgm: MigrationBuilder): Promise<void> {
  ...
  pgm.createMaterializedView(
    viewEstablishments,
    {},
    establishmentsMaterializedView("down"),
  );
  pgm.createMaterializedView(
    viewEstablishmentsWithAggregatedOffers,
    {},
    viewEstablishmentsWithAggregatedOffersSql("down"),
  );
  pgm.createMaterializedView(
    viewEstablishmentWithFlattenOffers,
    {},
    viewEstablishmentsWithFlattenOffersSql("down"),
  );
}

const establishmentsMaterializedView = (direction: "up" | "down") => {
  const nafColumns = {
    up: `
...
const nafColumnsForDerivatedViews = {
  up: `
...
const viewEstablishmentsWithAggregatedOffersSql = (
  direction: "up" | "down",
) => `
  ...
  ${nafColumnsForDerivatedViews[direction]}
...
const viewEstablishmentsWithFlattenOffersSql = (direction: "up" | "down") => `
  WITH offers_by_siret AS (
    SELECT e.siret,
