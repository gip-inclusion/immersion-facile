...
export async function up(pgm: MigrationBuilder): Promise<void> {
  ...
  createViewConventions(pgm, "up");
}

export async function down(pgm: MigrationBuilder): Promise<void> {
  pgm.dropView("view_conventions");
  createViewConventions(pgm, "down");
}

const createViewConventions = (
...
SELECT c.id,
       a."Nom"                                                                        AS "Structure",
       CASE
           WHEN a."Type" LIKE 'pole-emploi'
            THEN ${direction === "down" ? "'pole-emploi'" : "'france-travail'"}
           ELSE a."Type"
       END                                                                            AS "Type de structure",
