  ...
  implements ImmersionApplicationRepository
{
  ...
  public async save(
    ...
    // prettier-ignore
    const { id, status, email, firstName, lastName, phone, agencyCode, dateSubmission, dateStart, dateEnd, siret, businessName, mentor, mentorPhone, mentorEmail, schedule, individualProtection, sanitaryPrevention, sanitaryPreventionDescription, immersionAddress, immersionObjective, immersionProfession, immersionActivities, immersionSkills, beneficiaryAccepted, enterpriseAccepted, agencyId } =
      immersionApplicationEntity.toDto();

    const query = `INSERT INTO immersion_applications(
        id, status, email, first_name, last_name, phone, agency_code, date_submission, date_start, date_end, siret, business_name, mentor, mentor_phone, mentor_email, schedule, individual_protection,
  ...
  public async updateImmersionApplication(
    ...
    const query = `UPDATE immersion_applications
      SET status=$2,  email=$3,  first_name=$4,  last_name=$5,  phone=$6,  agency_code=$7, date_submission=$8, date_start=$9, date_end=$10, siret=$11,
        ...
        immersion_objective=$21, immersion_profession=$22, immersion_activities=$23, immersion_skills=$24, beneficiary_accepted=$25, enterprise_accepted=$26, agency_id=$27
      WHERE id=$1`;
  ...
  pgToEntity(params: Record<any, any>): ImmersionApplicationEntity {
    return ImmersionApplicationEntity.create({
      ...
      agencyCode: params.agency_code ?? undefined,
      agencyId: params.agency_id ?? undefined,
