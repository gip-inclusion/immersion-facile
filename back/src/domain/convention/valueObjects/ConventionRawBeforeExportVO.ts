...
export type ConventionRawBeforeExportProps = Pick<
  ConventionDto,
  KeysForExport
> & { agencyName: string; immersionProfession: string };

export class ConventionRawBeforeExportVO {
  constructor(public readonly _props: ConventionRawBeforeExportProps) {}

  public toImmersionApplicationReadyForExportVO =
    (): ConventionReadyForExportVO => ({
      ...this.toTranslatedConvention(),
  ...
  private toTranslatedConvention = () => ({
    ...this._props,
