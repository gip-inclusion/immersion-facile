...
> {
  ...
  public async _execute(
    ...
    const poleEmploiConvention: PoleEmploiConvention = {
      ...
      nomPrenomFonctionTuteur: `${convention.mentor.firstName} ${convention.mentor.lastName} ${convention.mentor.job}`,
      telephoneTuteur: convention.mentor.phone,
      emailTuteur: convention.mentor.email,
