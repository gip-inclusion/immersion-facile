...
import { makeMarkEstablishmentsAsSearchableScript } from "../../domains/establishment/use-cases/MarkEstablishmentsAsSearchableScript";
...
const startScript = async () => {
  ...
  const markAsSearchableScript = makeMarkEstablishmentsAsSearchableScript({
    deps: {
...
export const triggerMarkEstablishmentsAsSearchableWhenMaxContactsAllows = ({
  exitOnFinish,
}: {
