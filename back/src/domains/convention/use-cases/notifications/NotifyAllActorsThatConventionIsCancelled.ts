...
export type NotifyAllActorsThatConventionIsCancelled = ReturnType<
  typeof makeNotifyAllActorsThatConventionIsCancelled
>;
...
export const makeNotifyAllActorsThatConventionIsCancelled = useCaseBuilder(
