...
describe("PgNotificationRepository", () => {
  ...
  describe("deleteOldestNotifications", () => {
    ...
    describe("createdAt Param", () => {
      it("when to range param set with one year ago, delete events that are created before one year ago", async () => {
        expectToEqual(
    ...
    describe("limit Param", () => {
      it("apply limit and delete oldest events and sms with limit 1 by priority", async () => {
        const limit = 1;
        expectToEqual(
          await pgNotificationRepository.deleteOldestNotifications({
            limit: limit,
      ...
      it("apply limit and delete oldest events with limit 4", async () => {
        const limit = 4;
        expectToEqual(
          await pgNotificationRepository.deleteOldestNotifications({
            limit: limit,
