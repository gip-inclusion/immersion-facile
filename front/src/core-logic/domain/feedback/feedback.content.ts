...
> = {
  ...
  "magic-link-interstitial": {
    "fetch.success": {
      action: authSlice.actions.confirmLoginByMagicLinkSucceded,
      title: "Connexion réussie",
      message: "Vous êtes maintenant connecté à Immersion Facilitée",
    },
    "fetch.error": {
      action: authSlice.actions.confirmLoginByMagicLinkFailed,
      title: "Erreur lors de la connexion via le lien magique",
      message: "Une erreur est survenue lors de la connexion via le lien magique",
    },
  },
  unused: {},
};
