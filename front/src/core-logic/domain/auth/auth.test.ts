...
describe("Auth slice", () => {
  ...
  describe("renew expired jwt", () => {
    ...
    it("should renew expired jwt successfully", () => {
      ...
      dependencies.jwtDecoder.nextDecodeJwtResult = {
        userId: "",
    ...
    it("should renew expired jwt failed on jwtDecoder Error", () => {
      ...
      dependencies.jwtDecoder.nextDecodeJwtResult = new Error(errorMessage);
    ...
    it("should renew expired jwt failed on unsupported JWT payload", () => {
      ...
      dependencies.jwtDecoder.nextDecodeJwtResult = unsupportedJwtPayload;
