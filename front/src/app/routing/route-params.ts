...
export const conventionValuesFromUrl = {
  ...
  establishmentTutorFirstName: param.query.optional.string,
  establishmentTutorLastName: param.query.optional.string,
  establishmentTutorJob: param.query.optional.string,
  establishmentTutorPhone: param.query.optional.string,
  establishmentTutorEmail: param.query.optional.string,
  establishmentRepresentativeFirstName: param.query.optional.string,
  establishmentRepresentativeLastName: param.query.optional.string,
  establishmentRepresentativePhone: param.query.optional.string,
  establishmentRepresentativeEmail: param.query.optional.string,
