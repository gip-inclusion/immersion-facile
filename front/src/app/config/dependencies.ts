...
import { createHttpDependencies } from "src/app/config/createHttpDependencies";
import { createInMemoryDependencies } from "src/app/config/createInMemoryDependencies";
...
export const adminGateway = dependencies.adminGateway;
