...
export const sidebarStepContent = (
  ...
  const contents = {
    immersion: [
      {
        title: useConventionTexts(internshipKind).agencySection.title,
        description: (
          <>
            <p>
      ...
      {
        title: useConventionTexts(internshipKind).beneficiarySection.title,
        description: (
          <>
            <p>
      ...
      {
        title: useConventionTexts(internshipKind).establishmentSection.title,
        description: (
          <>
            <p>
      ...
      {
        title:
          useConventionTexts(internshipKind).immersionHourLocationSection.title,
        description: (
          <>
            <p>
      ...
      {
        title: useConventionTexts(internshipKind).immersionDetailsSection.title,
        description: (
          <>
            <p>
