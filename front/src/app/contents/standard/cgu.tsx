...
const Version20260624CguContent = () => (
  <>
    <p>
      <strong>
        Les présentes conditions générales d’utilisation (dites « CGU ») fixent
    ...
    <p>
      ...
      rôle « Responsable ». La personne doit saisir un obligatoirement un
      courriel professionnel et y joindre un SIRET. Il désigne les comptes qui
      auront la fonction valideurs de conventions et peut attribuer d'autres
      droits à tout compte rattaché à cette structure : lecteur - prévalideur -
      administrateur. Il peut retirer ces droits ou les modifier dans les mêmes
      conditions.
    </p>
    <p>
      Si la création de compte concerne un organisme d’accompagnement, les
    ...
    <p>
      L’inscription se fait via ProConnect et est validée par les
      administrateurs de la structure de rattachement demandée ou le cas échant
