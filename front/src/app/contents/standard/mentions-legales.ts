export default {
  ...
  content: `<strong>Éditeur</strong>
  Ce site est édité au sein Groupement d'Intérêt Public Plateforme de l'inclusion :
  127 rue de grenelle, 75007 Paris 7
  ...
  <strong>Signaler un dysfonctionnement</strong>
