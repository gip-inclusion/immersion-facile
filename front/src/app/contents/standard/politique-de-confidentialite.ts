...
• Données relatives au formulaire de demande d’immersion (nom, prénom, numéro de téléphone, date de naissance) ;
...
Pour vous aider dans votre démarche, vous trouverez un modèle de courrier élaboré par la CNIL ici : <a href="https://www.cnil.fr/fr/modele/courrier/exercer-son-droit-dacces" target="_blank">https://www.cnil.fr/fr/modele/courrier/exercer-son-droit-dacces</a>

Nous nous engageons à répondre dans un délai raisonnable qui ne saurait dépasser 1 mois à compter de la réception de votre demande.

<strong>Qui va avoir accès à ces données ?</strong>
...
<strong>Quels sont nos sous-traitants ?</strong>
