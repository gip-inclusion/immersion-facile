...
import {
  ...
  type FirstnameMandatory,
  getFormattedFirstnameAndLastname,
  type LastnameMandatory,
...
const makeConventionFromDiscussion = ({
  ...
  signatories: {
    ...
    establishmentRepresentative: {
      ...
      firstName: connectedUser.firstName as FirstnameMandatory,
      lastName: connectedUser.lastName as LastnameMandatory,
