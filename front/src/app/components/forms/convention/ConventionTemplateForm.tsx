...
import { EmailValidationErrorsState, makeInitialBenefiaryForm, useWaitForReduxFormUiReadyBeforeInitialisation } from "src/app/components/forms/convention/conventionForm.helpers";
        ...
        form={
          <FormProvider {...methods}>
            {mode === "create-from-scratch" && (
              <div className={cx("fr-text")}>{t.intro.welcomeCongratulations}</div>
            )}
