...
export const JustificationModalContent = forwardRef<
  ModalContentRef,
  {
...
>(
  (
    { onSubmit, closeModal, newStatus, convention, currentSignatoryRoles },
    ref,
  ) => {
    ...
    useExposeFormModalContentRef(ref, {
      handleSubmit,
      onFormSubmit,
      submitButtonLabel: confirmByStatus[newStatus],
      cancelButtonLabel: "Annuler",
      submitButtonId: submitButtonIdByStatus[newStatus],
      cancelButtonId: cancelButtonIdByStatus[newStatus],
    });
