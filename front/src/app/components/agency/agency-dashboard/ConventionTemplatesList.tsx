...
export const ConventionTemplatesList = ({ fromRoute }: { fromRoute: Route<typeof routes.agencyDashboard | typeof routes.establishmentDashboard>; }) => {
  return (
    <HeadingSection
      ...
      titleAction={
        <Button
          ...
          linkProps={routes.conventionTemplate({ fromRoute: fromRoute.name }).link}
        >
