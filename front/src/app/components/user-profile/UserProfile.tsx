              ...
              userWithRightsAgencies.length === 0 ? (
                ...
                >
                  <div className={fr.cx("fr-col-12", "fr-col-md-8")}>
                    ...
                    <p>
                      Vous n’êtes actuellement rattaché(e) à aucun organisme.
                    </p>
                    <p>
                      Un organisme (France Travail, Mission Locale, Cap emploi,
                      Conseil Départemental, etc.) permet de valider les
                      conventions d’immersion ou encore de suivre les
                      immersions.
                    </p>
                    <Highlight className={fr.cx("fr-ml-0")} size="sm">
                      Vous pourrez d’abord vérifier si votre organisme existe
                      déjà pour demander à y être rattaché(e). S’il n’existe pas
                      encore, vous serez guidé(e) vers le formulaire de
                      création.
                    </Highlight>
                    <Button
                  ...
                  >
                    <img
                      src={commonIllustrations.discussions}
                      alt="Accès limité"
                    />
                  </div>
                </div>
              ...
              userWithRightsEstablishments.length === 0 ? (
                ...
                >
                  <div className={fr.cx("fr-col-12", "fr-col-md-8")}>
                    ...
                    <p>
                      Être rattaché(e) à une entreprise permet de gérer les
                      offres d’immersion, accéder aux mises en relation et
                      suivre les immersions.
                    </p>
                    <Highlight className={fr.cx("fr-ml-0")} size="sm">
                      Vous pourrez d’abord vérifier si votre entreprise existe
                      déjà pour demander à y être rattaché(e). Si elle n’existe
                      pas encore, vous serez guidé(e) vers le formulaire de
                      création.
                    </Highlight>
                    ...
                    <Button
                      ...
                      priority="primary"
                      linkProps={
                        routes.myProfileEstablishmentRegistration().link
                      }
                      className={fr.cx("fr-ml-auto")}
                      iconId="fr-icon-add-line"
                    >
